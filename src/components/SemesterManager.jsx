              ...
              <div className="p-6">
                ...
                <div className="space-y-3">
                  {semester.courses.map((course) => (
                    <div
                      key={course.id}
                      className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-start bg-slate-50/40 sm:bg-transparent p-3 sm:p-0 rounded-xl border border-slate-100 sm:border-none"
                    >
                      <div className="sm:col-span-4 lg:col-span-3">
                        ...
                        <AutoResizeTextarea
                          ...
                          className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-800 rounded-xl px-3 py-2 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-all duration-200 font-medium placeholder:text-slate-300 text-slate-700 dark:text-slate-100 resize-none overflow-hidden min-h-[42px]"
                        />
                      </div>
                      ...
                      <div className="sm:col-span-2 lg:col-span-2">
                        ...
                        <input
                          ...
                          placeholder="3"
                          className="course-credits w-full min-w-[4rem] bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-800 rounded-xl px-3 py-2 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-all duration-200 font-bold text-center text-slate-700 dark:text-slate-100"
                        />
                      </div>
                ...
                <div className="mt-5 pt-4 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-4">
                  ...
                  <div className="bg-slate-50 border border-slate-200/60 rounded-xl px-4 py-2 flex items-center gap-6 text-xs font-semibold text-slate-500">
                    ...
                    <div>Semester GPA: <span className="text-indigo-600 dark:text-indigo-400 font-bold text-sm">{formatGpa(semStats.gpa)}</span></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="sticky top-24 space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs font-semibold text-slate-600">
              <div className="flex justify-between p-2 bg-slate-50 rounded-lg"><span>A+</span> <span className="text-indigo-600 font-bold">4.00</span></div>
              <div className="flex justify-between p-2 bg-slate-50 rounded-lg"><span>A</span> <span className="text-indigo-600 font-bold">4.00</span></div>
